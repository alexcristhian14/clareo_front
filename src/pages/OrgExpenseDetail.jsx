...
import { formatCents, formatDate, formatDateTime, statusLabel, sanitizeDescription } from "../utils/format";
        ...
        <div className="bg-white rounded-[10px] p-6 border border-zinc-200">
          ...
          <dl className="space-y-3 text-sm">
            <div className="flex justify-between">
              ...
              <dd className="font-medium text-slate-800">{sanitizeDescription(expense.description)}</dd>
            </div>
            <div className="flex justify-between">
